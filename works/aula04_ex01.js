...
var cylinderMaterial3 = new THREE.MeshPhongMaterial( {color:"yellow" } );
...
var cylinderMaterial4 = new THREE.MeshPhongMaterial( {color:"yellow" } );
...
function rotateCylinder()
{
  ...
  // Disables auto updates for the new cylinders
  ...
  if(animationOn)
  {
    ...
    // Rotation movements for the brand new cylinders
    // Will execute R2, T1 and R1 in this order
...
function buildInterface()
{
  ...
  gui.add(controls, 'speed', 0.01, 0.5) // default limit was 0.05 to 0.5
